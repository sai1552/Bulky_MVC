...
{
    /// <inheritdoc />
    public partial class addnewtoDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Ponnur", "Tech Solutions", "2354656444", "522315", "A.P", "Ramalayam" },
                    { 2, "Vivid city", "Vivid Books", "3354656444", "522313", "KL", "999 vivid street" },
                    { 3, "Readers st", "Readers Club", "36372829221", "522345", "KA", "Whitefield" }
                });
